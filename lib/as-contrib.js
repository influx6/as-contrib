require('em.js')('as-contrib',function(em){
    
    var asc = this.exports = { }, 
      as = em('appstack'), 
      ds = em('ds'), 
      streams = em('streams'),
      util = as.Utility;
    ...
    var enums = asc.enums = {},
        invs = asc.invokable = {},
        notify = asc.notifiers = {},
        valtors = asc.validators = {};
    ...
    valtors.truthy = function(n){ return (!this.isNull(n) && !this.isUndefined(n) && n !== false); };
    valtors.falsy = function(n){ return !this.truthy(n); };
    valtors.isBoolean = util.bind(util.isBoolean,util);
    valtors.isArgument = util.bind(util.isArgument,util);
    valtors.isType = util.bind(util.isTrue,util);
    ...
    valtors.isElement = valtors.isKV = function(n){
      if(!valtors.isString(n) && !valtors.isArgument(n) && !valtors.isObject(n) && !valtors.isArray(n)) return false;
      return true;
    };
    ...
    enums.bind = util.bind(util.proxy,util);
    enums.extends = util.bind(util.extends,util);
    ...
    enums.identity = function(n){
      return n;
    };

    enums.always = function(n){
      return function(){
        return n;
      };
    };
    ...
    valtors.NotExist = enums.notExist = function(n){
      return (n === null || typeof n === 'undefined');
    };

    valtors.exists = enums.exists = enums.negate(enums.notExist);
  ...
  enums.pair = enums.IndexedElement(function(n){
    
  });
      
  enums.toObject = function(n){
 ...
 invs.fnull = function(func){
  ...
  return function(){
    var args = enums.map(arguments,function(e,i){
  ...
  invs.gatherArgs = function(fn,n,arg){
    ...
    return function(){
      ...
      return enums.gatherArgs(fn,n,sets);
    };
  };
