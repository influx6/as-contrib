module.exports = function(ma,as){
    ...
    var enums = as.enums, valids = as.validators, inv = as.invokable;
    ...
    var dispatch = enums.dispatch(function(n){
      if(valids.isArray(n)) return n.length;
    },function(n){
      if(valids.isObject(n)) return n;
    },function(n){
      if(valids.isString(n)) return "{String:"+n+"}";
    });
